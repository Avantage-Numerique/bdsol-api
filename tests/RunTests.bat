...
CALL newman run BDSOL-API.postman_collection.json --folder CreateEnvVariable-pers --working-dir %cd% -g workspace.postman_globals.json -e ./Personnes/personnes.postman_environment.json --export-environment ./Personnes/personnes.postman_environment.json --timeout-request 5000
