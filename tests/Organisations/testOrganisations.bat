...
PAUSE
CALL newman run BDSOL-API.postman_collection.json --folder 5-Delete-all-org --working-dir %cd% -g workspace.postman_globals.json --export-globals ./workspace.postman_globals.json -e ./Organisations/organisations.postman_environment.json --export-environment ./Organisations/organisations.postman_environment.json --timeout-request 5000
PAUSE