...
PAUSE
CALL newman run BDSOL-API.postman_collection.json --folder Search-Entity --working-dir %cd% -g workspace.postman_globals.json -e ./Personnes/personnes.postman_environment.json --export-environment ./Personnes/personnes.postman_environment.json -d ./Personnes/Search-DataFile.json --timeout-request 5000
PAUSE
CALL newman run BDSOL-API.postman_collection.json --folder List-Entity --working-dir %cd% -g workspace.postman_globals.json -e ./Personnes/personnes.postman_environment.json --export-environment ./Personnes/personnes.postman_environment.json -d ./Personnes/List-Datafile.json --timeout-request 5000
PAUSE
