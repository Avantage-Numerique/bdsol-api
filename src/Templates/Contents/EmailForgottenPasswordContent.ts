const EmailForgottenPasswordContent: any = (
    welcomeName: string,
    link: string,
    username: string,
    ...
    return {
        context: {
            ...
            conclusion:
                "<br/><br/><strong>Important</strong> <u>Si vous n’êtes pas à l’origine de cette demande sur avnu.ca</u>, veuillez ignorer ce courriel, et merci de nous contacter pour nous avertir de la situation.<br/><u>Veuillez ne pas répondre à courriel.</u>",
