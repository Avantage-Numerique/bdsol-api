...
const EmailPasswordChangedContent:any = (welcomeName:string, link:string, additionnalContext:any={}) => {
    return {
        context: {
            ...
            conclusion: "<br/><br/><strong>Important</strong> <u>Si vous n’êtes pas à l’origine de cette modification sur avnu.ca</u>, veuillez nous contacter via notre courriel pour nous informer de la situation.",
            cta: {
