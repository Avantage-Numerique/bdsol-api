...
const getApiConfig = () => {
    return {
        ...
        localhostDb: {
            ...
            additionalUrlParams: process.env.LOCALHOST_DB_ADDITIONAL_URL_PARAMS
                ? process.env.LOCALHOST_DB_ADDITIONAL_URL_PARAMS
        ...
        distantDb: {
            ...
            authSource:
                process.env.DB_AUTHSOURCE !== "false" && process.env.DB_AUTHSOURCE !== "0"
                    ...
                    : "",
            addAuthSource: process.env.DB_ADD_AUTHSOURCE === "true",
            additionalUrlParams: process.env.DISTANT_DB_ADDITIONAL_URL_PARAMS
                ? process.env.DISTANT_DB_ADDITIONAL_URL_PARAMS
                : "", // '&replicaSet=replicaset&tls=true',
        ...
        migrations: {
            ...
            additionalUrlParams: process.env.DB_MIGRATION_ADDITIONAL_URL_PARAMS
                ? process.env.DB_MIGRATION_ADDITIONAL_URL_PARAMS
                : "",
