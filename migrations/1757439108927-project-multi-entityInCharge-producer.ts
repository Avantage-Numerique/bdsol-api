...
const setExistingStringToArray: Array<{ collection: string, queries: Array<any>, match?: any }> = [
  {
    collection: "projects",
...
const setEmptyStringToEmptyArray: Array<{ collection: string, queries: Array<any>, match?: any }> = [
  {
    collection: "projects",
    match: {
      $or: [
...
export async function up(): Promise<void> {
  ...
  await runQueriesOnDatabase(driver, 'bdsol-data', setExistingStringToArray, 'Upgrading entityInCharge & producer on Project : string that are not empty into array of relations', 'up');
  await runQueriesOnDatabase(driver, 'bdsol-data', setEmptyStringToEmptyArray, 'Upgrading entityInCharge & producer on Project : string that are empty into empty array', 'up');
}
