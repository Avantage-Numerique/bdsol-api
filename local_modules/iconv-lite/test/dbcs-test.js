...
var iconvChanges = {
    // Characters that iconv changing (iconv char -> our char)
...
var iconvCannotDecode = {
    // Characters that we can decode, but iconv cannot. Encoding -> correct char. Also use them for encoding check.
    ...
    gbk: {
        // All these will appear in GB18030, + U+0080 = € is compatibility with Windows.
        80: "€",
        a2e3: "€",
        a8bf: "ǹ",
        a98a: "⿰",
